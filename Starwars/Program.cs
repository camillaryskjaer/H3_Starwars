...
namespace Starwars
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IEnumerable<Planet> resultList = planets.Where(x => x.Name.StartsWith("M"));
            ...
            resultList = planets.Where(x => x.Name.ToUpper().Contains("Y"));
            ...
            resultList = planets.Where(x => x.RotationPeriod > 40).OrderBy(x => x.RotationPeriod);
            ...
            resultList = planets.Where(x => x.RotationPeriod > 10 && x.RotationPeriod < 20).OrderBy(x => x.Name);
            ...
            resultList = planets.Where(x => x.RotationPeriod > 30).OrderBy(x => x.Name).ThenBy(x => x.RotationPeriod);
            ...
            resultList = planets.Where(x => x.SurfaceWater > 0).OrderByDescending(x => x.SurfaceWater);
            ...
            resultList = planets.Where(x => (x.Diameter != 0 && x.Population != 0))
                                .OrderBy(x => ((4 * Math.PI * (x.Diameter / 2) * (x.Diameter / 2) / x.Population)));
